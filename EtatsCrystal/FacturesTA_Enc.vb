...
Public Class FacturesTA_Enc
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SosMedecins.SmartRapport.EtatsCrystal.FacturesTA_Enc.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFacturesTA_Enc
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FacturesTA_Enc = New FacturesTA_Enc()
        rpt.Site = Me.Site
        Return rpt
    End Function

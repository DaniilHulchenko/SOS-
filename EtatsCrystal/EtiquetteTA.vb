...
Public Class EtiquetteTA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SosMedecins.SmartRapport.EtatsCrystal.EtiquetteTA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEtiquetteTA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EtiquetteTA = New EtiquetteTA()
        rpt.Site = Me.Site
        Return rpt
    End Function

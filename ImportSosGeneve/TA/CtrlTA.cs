...
namespace ImportSosGeneve
{
    ...
    public class CtrlTA : System.Windows.Forms.UserControl
    {
        ...
        public void MajMateriel(string ContactID, string IdAbonnement, string[] TypeOpe)
        {
           ...
           // SqlTransaction transaction;             //Pour l'insert avec transaction
                    ...
                    MessageBox.Show(
                        ...
                        $"TypeOpe = {TypeOpe[0]}\n" +
                        $"SQL = {cmd.CommandText}\n" +
                        $"Params: IdAbonnement='{IdAbonnement}', IdContact='{CID}', TypeOpe[1]='{TypeOpe[1]}'"
                    );
                    int rows = cmd.ExecuteNonQuery();
                    MessageBox.Show($"[LOG MajMateriel] Rows affected = {rows}");
                ...
                MessageBox.Show("ERROR MajMateriel:\n" + ex.Message + "\n" + ex.StackTrace);
        ...
        private void listViewMat1_DoubleClick(object sender, EventArgs e)
        {
            ...
            MessageBox.Show($"[LOG Complete] Chaine='{Chaine}', longueur={longueur}, nbCara={nbCara}, RETURN='{ChaineFinale}'");

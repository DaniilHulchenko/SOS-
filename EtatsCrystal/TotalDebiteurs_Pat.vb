...
Public Class TotalDebiteurs_Pat
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SosMedecins.SmartRapport.EtatsCrystal.TotalDebiteurs_Pat.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTotalDebiteurs_Pat
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TotalDebiteurs_Pat = New TotalDebiteurs_Pat()
        rpt.Site = Me.Site
        Return rpt
    End Function

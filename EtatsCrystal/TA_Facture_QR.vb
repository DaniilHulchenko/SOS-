...
Public Class TA_Facture_QR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SosMedecins.SmartRapport.EtatsCrystal.TA_Facture_QR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTA_Facture_QR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TA_Facture_QR = New TA_Facture_QR()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class EtatStopRapTA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SosMedecins.SmartRapport.EtatsCrystal.EtatStopRapTA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEtatStopRapTA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EtatStopRapTA = New EtatStopRapTA()
        rpt.Site = Me.Site
        Return rpt
    End Function

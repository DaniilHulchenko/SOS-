    ...
    public class CtrlTA : System.Windows.Forms.UserControl
    {
        ...
        private void bEnregistrer_Click(object sender, EventArgs e)
        {
            ...
            if (tbAbonnement.Tag != null)
            {
                ...
                if (int.Parse(txtIdContrat.Text) >= 30000 || rBTypeBoitier4.Checked)
                {                   
                    Medicalerte = 1;                    
                }
        ...
        public void MajMateriel(string ContactID, string IdAbonnement, string[] TypeOpe)
        {
            ...
            // transaction = dbConnection.BeginTransaction("transac");     //D?marre une transaction locale
            ...
            try
            {
                ...
                // ÂÀÆÍÎ: AjoutModules îáðàáàòûâàåì êàê Ajout,
                // ÷òîáû ïðè çàìåíå/äîáàâëåíèè DOMO 4G òîæå ïðîñòàâëÿëñÿ IdAbonnement
                if (TypeOpe[0] == "Ajout" || TypeOpe[0] == "AjoutModules")    //Ajout d'une Box ET du m?daillon attach? ? cette derniere
                {
                ...
                {
                    //Suppression du luna (sans son m?daillon) Pour attribution d'un autre du m?me type
                    sqlstr0 = "Update TA_Materiel ";
                    ...
                    sqlstr0 += " WHERE ContactID = @IdContact";
                    // ÄÎÁÀÂËßÅÌ D4G  äîìî 4G êîðîáêè òîæå ïîïàäàþò â îáíîâëåíèå
                    ...
                    //Puis ajout de la nouvelle box (sans le m?daillon associ?)
                    sqlstr0 = "Update TA_Materiel ";
                    sqlstr0 += " Set IdAbonnement = @Abonnement, ";
                    ...
                    //Les m?daillons:
                    //On d?associe le m?daillon de la NVLLE box de tout: ContactId = 00000000)
                    sqlstr0 = "Update TA_Materiel ";
                    ...
                    //On affecte l'ANCIEN m?daillon ? la nouvelle box
                    sqlstr0 = "Update TA_Materiel ";
                ...
                else if (TypeOpe[0] == "Changement de version" || TypeOpe[0] == "R?affectation de boitier")
                {
                    //Suppression du luna (sans son m?daillon) Pour attribution d'un autre mod?le de boitier
                    sqlstr0 = "Update TA_Materiel ";
                    sqlstr0 += " Set IdAbonnement = Null, ";
                    sqlstr0 += " DateDerniereAttrib = getdate()";
                    sqlstr0 += " WHERE ContactID = @IdContact";
                    // ÒÓÒ ÒÎÆÅ äîáàâëåí D4G, ÷òîáû ñìåíà LUNA -> DOMO 4G ðàáîòàëà
                    sqlstr0 += " AND Type_tarif in ('L3GSL', 'L3G', 'L4', 'D4G')";
                ...
                {
                    //Suppression du luna...remise en stock avec son m?daillon
                    sqlstr0 = "Update TA_Materiel ";
                    sqlstr0 += " Set IdAbonnement = Null ";
                    sqlstr0 += " WHERE IdAbonnement = @Abonnement";
                ...
                // transaction.Commit();          //On commit la transaction
            }
            catch (Exception ex)
            {
                // transaction.Rollback();
                MessageBox.Show("Erreur Lors de la mise ? jour du TA_Materiel... Le message est: " + ex.Message);
            }
            finally
            {
                dbConnection.Close();

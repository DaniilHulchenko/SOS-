...
Public Class QR_BVR_Libre
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SosMedecins.SmartRapport.EtatsCrystal.QR_BVR_Libre.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedQR_BVR_Libre
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As QR_BVR_Libre = New QR_BVR_Libre()
        rpt.Site = Me.Site
        Return rpt
    End Function

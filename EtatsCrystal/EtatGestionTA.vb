...
Public Class EtatGestionTA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SosMedecins.SmartRapport.EtatsCrystal.EtatGestionTA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEtatGestionTA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EtatGestionTA = New EtatGestionTA()
        rpt.Site = Me.Site
        Return rpt
    End Function

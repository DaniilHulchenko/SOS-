...
Public Class EtatFicheConsult
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SosMedecins.SmartRapport.EtatsCrystal.EtatFicheConsult.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEtatFicheConsult
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EtatFicheConsult = New EtatFicheConsult()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class SansRapport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SosMedecins.SmartRapport.EtatsCrystal.SansRapport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSansRapport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SansRapport = New SansRapport()
        rpt.Site = Me.Site
        Return rpt
    End Function

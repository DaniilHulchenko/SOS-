...
Public Class TA_Facture2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SosMedecins.SmartRapport.EtatsCrystal.TA_Facture2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTA_Facture2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TA_Facture2 = New TA_Facture2()
        rpt.Site = Me.Site
        Return rpt
    End Function

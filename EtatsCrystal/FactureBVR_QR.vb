...
Public Class FactureBVR_QR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SosMedecins.SmartRapport.EtatsCrystal.FactureBVR_QR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFactureBVR_QR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FactureBVR_QR = New FactureBVR_QR()
        rpt.Site = Me.Site
        Return rpt
    End Function

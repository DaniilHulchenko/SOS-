...
Public Class QR_BVR_TA_Mat
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SosMedecins.SmartRapport.EtatsCrystal.QR_BVR_TA_Mat.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedQR_BVR_TA_Mat
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As QR_BVR_TA_Mat = New QR_BVR_TA_Mat()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class EtatDebiteursTrie
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SosMedecins.SmartRapport.EtatsCrystal.EtatDebiteursTrie.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEtatDebiteursTrie
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EtatDebiteursTrie = New EtatDebiteursTrie()
        rpt.Site = Me.Site
        Return rpt
    End Function

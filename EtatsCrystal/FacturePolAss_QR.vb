...
Public Class FacturePolAss_QR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SosMedecins.SmartRapport.EtatsCrystal.FacturePolAss_QR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFacturePolAss_QR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FacturePolAss_QR = New FacturePolAss_QR()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class CessionDeCreance
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SosMedecins.SmartRapport.EtatsCrystal.CessionDeCreance.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCessionDeCreance
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CessionDeCreance = New CessionDeCreance()
        rpt.Site = Me.Site
        Return rpt
    End Function

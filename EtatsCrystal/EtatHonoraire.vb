...
Public Class EtatHonoraire
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SosMedecins.SmartRapport.EtatsCrystal.EtatHonoraire.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEtatHonoraire
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EtatHonoraire = New EtatHonoraire()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class LectureXml
    ...
    Public Sub New()
        _strNomFichier = Application.StartupPath + "\Config.xml"
    End Sub
    ...
    Public Function GetValue(ByVal p_strNoeud As String, ByVal p_strElement As String) As String
        ...
        z_xmlNoeud = z_xmlDoc.SelectNodes(p_strNoeud)
        For Each z_xml As XmlNode In z_xmlNoeud.Item(0)
            If z_xml.Name = p_strElement Then
                Return z_xml.InnerText
            End If
        Next

        Throw New Exception("Impossible de lire le parametre " & p_strNoeud & " - " & p_strElement)

        Return Nothing
    End Function

    Public Function SetValue(ByVal p_strElement As String, ByVal p_strValeur As String, Optional ByVal p_blnCreation As Boolean = True) As Boolean
        Dim z_xmlDoc As XmlDocument
        Dim z_xmlNoeud As XmlNodeList

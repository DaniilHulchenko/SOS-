...
Public Class TA_FactMat_Detail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SosMedecins.SmartRapport.EtatsCrystal.TA_FactMat_Detail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTA_FactMat_Detail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TA_FactMat_Detail = New TA_FactMat_Detail()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class TA_FactureMat_QR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SosMedecins.SmartRapport.EtatsCrystal.TA_FactureMat_QR.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Rappel() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedTA_FactureMat_QR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TA_FactureMat_QR = New TA_FactureMat_QR()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
namespace ImportSosGeneve
{
	...
	/// <summary>
        private const string RapportVisaRefuseMessage = "Le rapport a t lu par le mdecin responsable, le visa n'a pas t accord.";
	...
	public class frmGeneral : Form
	{
        ...
        #region Déclaration des variables globales
		...
		private System.Windows.Forms.Button btnRapport_VisaRefuse;
		...
		private void InitializeComponent()
		{
            ...
            this.btnRapport_VisaRefuse = new System.Windows.Forms.Button();
            ...
            this.tbVisa.Controls.Add(this.btnRapport_VisaRefuse);
            ...
            // btnRapport_VisaRefuse
            // 
            this.btnRapport_VisaRefuse.BackColor = System.Drawing.Color.Transparent;
            this.btnRapport_VisaRefuse.FlatStyle = System.Windows.Forms.FlatStyle.Popup;
            this.btnRapport_VisaRefuse.Font = new System.Drawing.Font("Microsoft Sans Serif", 9.75F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.btnRapport_VisaRefuse.ForeColor = System.Drawing.Color.Black;
            this.btnRapport_VisaRefuse.Location = new System.Drawing.Point(264, 160);
            this.btnRapport_VisaRefuse.Name = "btnRapport_VisaRefuse";
            this.btnRapport_VisaRefuse.Size = new System.Drawing.Size(160, 72);
            this.btnRapport_VisaRefuse.TabIndex = 5;
            this.btnRapport_VisaRefuse.Text = "Refuser le visa";
            this.btnRapport_VisaRefuse.UseVisualStyleBackColor = false;
            this.btnRapport_VisaRefuse.Click += new System.EventHandler(this.btnRapport_VisaRefuse_Click);

            this.btnEnlevCorrection.Text = "Enlever la demande de correction du secrétariat";
            ...
            this.BtnRapport_Visa.Size = new System.Drawing.Size(104, 72);
		...
		private void btnRapportCourant_Click(object sender, System.EventArgs e)
		{
			...
			// Si le numéro de rapport = -1, Il n'est pas encore généré, on le génére..
			if(Index[1]==-1)
			{
                if (VariablesApplicatives.Utilisateurs.Droits == VariablesApplicatives.Utilisateurs.CodeDroits.Medecin)
				{
					    ...
					    if(result==DialogResult.No)
                                            {
                                                    ...
                                                    ClearRapportVisaRefuse(rapportRow);
                                                    OutilsExt.OutilsSql.UpdateRapSignature(rapportRow.NRapport, rapportRow.RapSignature);
		...
		private void BtnRapport_Visa_Click(object sender, System.EventArgs e)
		{
            ...
            try
            {
               ...
               // var userIPV6 = Dns.GetHostEntry(userHost).AddressList[0].ToString();    //ip V6
                ...
                private bool RapportEstVisaRefuse(dstRapport.RapportRow rapportRow)
                {
                        return rapportRow != null && !rapportRow.IsRapSignatureNull() && rapportRow.RapSignature != null && rapportRow.RapSignature.StartsWith(RapportVisaRefuseMessage);
                }

                private void ClearRapportVisaRefuse(dstRapport.RapportRow rapportRow)
                {
                        if(rapportRow == null) return;
                        if(RapportEstVisaRefuse(rapportRow))
                        {
                                if(rapportRow.IsNomMedecinSosNull())
                                        rapportRow.RapSignature = string.Empty;
                                else
                                        rapportRow.RapSignature = rapportRow.NomMedecinSos;
                        }
                }

                private void btnRapport_VisaRefuse_Click(object sender, System.EventArgs e)
                {
                        if(Donnees.MonDtRapport==null || Donnees.MonEtatRapport==null || crystalReportViewer1.ActiveViewIndex==-1) return;
                        try
                        {
                                ...
                                dstRapport.RapportRow rapportRow = Donnees.MonDtRapport.Rapport[crystalReportViewer1.ActiveViewIndex];
                                string commentaireSauvegarde = txtRapport_CommentaireSauvegarde.Text;
                                string commentaireVisa = TxtRapport_CommentaireVisa.Text;

                                OutilsExt.OutilsSql.SauvegardeRapport(rapportRow, Donnees.MonDtCorps, Donnees.MonDtDestination, VariablesApplicatives.Utilisateurs.Identifiant, "", commentaireSauvegarde);
                                ...
                                string signatureText = string.IsNullOrEmpty(nomMedecin) ? RapportVisaRefuseMessage : RapportVisaRefuseMessage + Environment.NewLine + nomMedecin;

                                OutilsExt.OutilsSql.VisaSurRapport(rapportRow, false, signatureText);

                                rapportRow.RapSignature = signatureText;
                                rapportRow.Vise = 0;
                                ...
                                z_objMail.JoindrePiece(Application.StartupPath + SosMedecins.SmartRapport.Systeme.OutilsExt.ParamAppli.Cache + FileName + ".pdf");
                                z_objMail.Message = "";
                                z_objMail.Sujet = "[Visa refus] Rapport patient " + Donnees.MonDtRapport.Rapport[0].NomPatient + " " + Donnees.MonDtRapport.Rapport[0].PrenomPatient + " " + Donnees.MonDtRapport.Rapport[0].DAP.ToShortDateString();
                                z_objMail.Envoi();
                                ...
                                var userHost = Dns.GetHostName();
                                var addressList = Dns.GetHostEntry(userHost).AddressList;
                                string userIPV4 = addressList.Length > 1 ? addressList[1].ToString() : addressList[0].ToString();

                                mouchard.evenement("Rapport n " + rapportRow.NRapport.ToString() + " visa refus sur le poste " + userHost.ToString() + " ayant pour adresse ip: " + userIPV4.ToString(), VariablesApplicatives.Utilisateurs.NomUtilisateur.ToString());
                        }
                        catch(Exception ex)
                        {
                                MessageBox.Show(ex.Message.ToString());
        ...
        #region A Travailler
				...
				if(Donnees.MonDtRapport.Rapport[crystalReportViewer1.ActiveViewIndex].Vise==1)
				else if(RapportEstVisaRefuse(Donnees.MonDtRapport.Rapport[crystalReportViewer1.ActiveViewIndex]))
					LblRapportVise.Text = "VISA REFUSE";

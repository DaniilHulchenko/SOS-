...
Public Class TA_FactureMat
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SosMedecins.SmartRapport.EtatsCrystal.TA_FactureMat.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTA_FactureMat
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TA_FactureMat = New TA_FactureMat()
        rpt.Site = Me.Site
        Return rpt
    End Function

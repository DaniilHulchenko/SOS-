...
Public Class EtatDebiteurs
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SosMedecins.SmartRapport.EtatsCrystal.EtatDebiteurs.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEtatDebiteurs
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EtatDebiteurs = New EtatDebiteurs()
        rpt.Site = Me.Site
        Return rpt
    End Function
